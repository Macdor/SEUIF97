...
3. Windows with MSVC: seuif97.dll
   ...
   Build:
     64 bits: cl /Fedemo.exe demo.c -I./include/ ../../shared_lib/Windows/x64-msvc/seuif97.lib
     32 bits: cl /Fedemo.exe demo.c -I./include/ ../../shared_lib/Windows/x86-msvc/seuif97.lib
